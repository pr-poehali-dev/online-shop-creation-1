...
const Index = () => {
  ...
  const featuredProducts: Product[] = [
    ...
    },
    {
      ...
      price: 18900,
      originalPrice: 24500,
      imageUrl: "https://images.unsplash.com/photo-1591047139829-d91aecb6caea?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1160&q=80",
      rating: 4.6,
      category: "Одежда",
      isSale: true
    },
    ...
    },
    {
      ...
      price: 4590,
      originalPrice: 5990,
      imageUrl: "https://images.unsplash.com/photo-1571781926291-c477ebfd024b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1688&q=80",
      rating: 4.9,
      category: "Красота",
      isSale: true
    },
    ...
    },
    {
      ...
      price: 23990,
      imageUrl: "https://images.unsplash.com/photo-1582980752625-3e3ccb32718b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80",
      rating: 4.4,
      category: "Дом и сад"
    },
    {
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-400">Наш интернет-магазин предлагает широкий ассортимент товаров высокого качества по доступным ценам.</p>
            </div>
            <div>
          ...
          <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-500">
            <p>© 2025 ShopMarket. Все права защищены.</p>
          </div>
        </div>
      </footer>
    </div>
